...
8-Posicionarse desde la consola en la ruta "Proyecto\proyecto" y ejecutar el comando: admin python manage.py createsuperuser (se pedirá luego el nombre de usuario y la contrseña, se creara el perfil del administrador y se accederá al mismo a travez de http://127.0.0.1:8000/admin/
